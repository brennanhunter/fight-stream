        ...
        <div className="bg-gradient-to-r from-primary via-red-600 to-primary p-6 border-b-2 border-accent/50">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/90 text-sm mt-1">Havoc at Hilton</p>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="bg-black/40 border-b border-accent/20 p-4">
          <div className="flex items-center justify-between text-sm">
            <div className="space-y-1">
              ...
              <p className="text-white font-semibold">November 8, 2025 at 6:00 PM EST</p>
            </div>
            <div className="text-right space-y-1">
              <p className="text-gray-400">Price</p>
              <p className="text-accent font-bold text-2xl">$21.99</p>
            </div>
          </div>
        </div>
