...
<head>
  ...
  <title>Subscription Canceled – BoxStreamTV</title>
</head>
<body style="margin:0;padding:0;background-color:#000000;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;">
          ...
          <tr>
            <td style="border:1px solid rgba(255,255,255,0.12);padding:40px 36px;background-color:#0a0a0a;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#9ca3af;text-align:center;line-height:1.6;">
                Your Fight Pass ${tierLabel} subscription has been canceled.
                ${
                  accessUntilFormatted
                    ? `You&rsquo;ll keep full access to all your content until <strong style="color:#ffffff;">${accessUntilFormatted}</strong>.`
                  ...
                  ? `<table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid rgba(255,255,255,0.1);margin-bottom:28px;">
                      <tr>
                        <td style="padding:16px 20px;">
                          <p style="margin:0;font-size:10px;font-weight:700;letter-spacing:0.2em;text-transform:uppercase;color:#6b7280;">Access ends</p>
                          <p style="margin:6px 0 0;font-size:16px;font-weight:600;color:#ffffff;">${accessUntilFormatted}</p>
                        </td>
                      </tr>
                    </table>`
                  : ''
  ...
  const text = `Subscription Canceled – BoxStreamTV

Your Fight Pass ${tierLabel} subscription has been canceled.
${
  accessUntilFormatted
    ? `You'll keep full access until ${accessUntilFormatted}.`
    : 'Your access will remain active until the end of your current billing period.'
}
