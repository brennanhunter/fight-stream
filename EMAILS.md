...
| 8 | Event reminder — 24 hours before | Scheduled job: 24h before event date | ⬜ |
| 9 | Event is live right now | Admin marks event as active | ⬜ |
| 10 | Replay now available | Admin marks event as ended | ⬜ |
